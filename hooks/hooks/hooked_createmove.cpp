...
void __stdcall hooks::new_hooked_createmove(int sequence_number, float input_sample_frametime, bool active, bool& bSendPacket)
{
	static auto original_fn = hooks::client_hook->get_func_address <newCreateMove_t>(22);
